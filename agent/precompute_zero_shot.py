...
def main(args):
    ...
    if args.name_score_variable is not None:
        all_scores[args.name_score_variable] = all_scores.iloc[:,-1]
        all_scores = all_scores[['mutated_sequence',args.name_score_variable]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name_score_variable', default=None, type=str, help='Name of scoring variable')
