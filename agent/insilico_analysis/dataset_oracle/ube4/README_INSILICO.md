...
- `insilico_analysis/gfp/top10_from_results.py`
  ...
  - Example:
    ```bash
    python3 insilico_analysis/gfp/top10_from_results.py \
...
- `insilico_analysis/gfp/plot_avg_fitness_over_rounds.py`
  ...
  - Example:
    ```bash
    python3 insilico_analysis/gfp/plot_avg_fitness_over_rounds.py \
